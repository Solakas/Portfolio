        ...
        {activeSection === "home" && (
          ...
          >
            ...
            >
              ...
              <div 
                ref={containerRef}
                className="w-full flex-1 lg:flex-1 flex items-end justify-center h-auto lg:h-[46vh] xl:h-[52vh] relative px-4 self-end cursor-crosshair group/portrait overflow-hidden rounded-t-2xl rounded-b-none order-3 lg:order-none"
